...
if generate_test_imgs:
    ...
    model = PhospheneOptimizer(args=args,
                               ...
                               electrode_grid=1024,
                               batch_size=1,
                               n_phos=200) # TODO: Change here the number of phosphenes that should be outputted in the optimized image. It should match the number of phosphenes the model was trained on
